...
const float MeteoModel::radius = 5.0f;				// 底面の半径
const float MeteoModel::prizmHeight = 8.0f;			// 柱の高さ
...
{
	//MeteoSet=0:位置をplayer上に　MeteoSet=1:落下処理　MeteoSet=2:動きとめる
	if (Meteo_Set == 0) {
		//落石の位置をプレイヤーの上に
...
//左上-142,-8　右上142,-18 左下‐142,-166 右下146,-158
